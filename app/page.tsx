    ...
    <>
      ...
      <footer className="bg-background-light dark:bg-black border-t border-slate-200 dark:border-white/10 pt-16 pb-8">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center mb-12 gap-10 md:gap-6">
            ...
            <div className="flex-1 flex flex-col sm:flex-row sm:flex-wrap justify-center items-center gap-6 sm:gap-8 md:gap-10 text-center md:text-center text-sm text-slate-700 dark:text-slate-300 min-w-0">
              <div>
                ...
                <a href="mailto:info@heloadz.com" className="hover:text-primary transition-colors">info@heloadz.com</a>
            ...
            <div className="flex gap-8 shrink-0 justify-center md:justify-end">
              <a href="https://www.instagram.com/helo.adz/" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-accent transition-colors" aria-label="Instagram">
              ...
              <a
                href="https://www.linkedin.com/company/heloadz/"
                target="_blank"
          ...
          <div className="border-t border-slate-200 dark:border-white/5 pt-8 text-center text-sm text-slate-500 dark:text-slate-500">
            <p>© 2026 HeloAdz. All rights reserved.</p>
